...
using UnityEngine;
using UnityEngine.Tilemaps; // We need this to make Tiles & Tilemap work
...
public class TilemapManager : MonoBehaviour
{
    ...
    void LoadTiles()
    {
        ...
        // The order of the Tiles is not guranteed, so arrange them by number
    ...
    ///</summary>
    /// <return> The TileBases for collisionMap</return>
